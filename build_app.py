...
Path('index.html').write_text(html.replace('__DATA__',json.dumps(data,separators=(',',':'))).replace('__ANSWER6__',answer6).replace('__ANSWER7__',answer7))
